...
namespace TestLibTracer
{
    internal class TestMaterial
    {
        ...
        public void Lighting_Returns_InstanceOfColour()
        {
            ...
            Assert.That(_material.Lighting(light, position, eye, normal), Is.InstanceOf<TColour>());
        }
        ...
        public void Lighting_ReturnsFullIntensity_WhenEyeBetweenLightAndSurface()
        {
            ...
            Assert.That(_material.Lighting(light, position, eye, normal), Is.EqualTo(expectedResult));
        }
        ...
        public void Lighting_ReturnsReducedIntensity_WhenEyeOppositeSurfaceLightAt45Degrees()
        {
            ...
            var result = _material.Lighting(light, position, eye, normal);
